...
public class DiscordPresence extends Module {
    ...
    private final Setting<List<String>> line2Strings = sgLine2.add(new StringListSetting.Builder()
        ...
        .defaultValue("MeteorExtra on Crack!", "{round(server.tps, 1)} TPS", "Playing on {server.difficulty} difficulty.", "{server.player_count} Players online")
    ...
    public void onActivate() {
        DiscordIPC.start(1363497002926608614L, null);
        ...
        rpc.setLargeImage("meteor", largeText);
