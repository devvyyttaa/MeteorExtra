...
import meteordevelopment.meteorclient.systems.modules.combat.criticals.CriticalsPlus;
import meteordevelopment.meteorclient.systems.modules.combat.killaura.KillAuraPlus;
import meteordevelopment.meteorclient.systems.modules.combat.velocity.VelocityPlus;
...
import meteordevelopment.meteorclient.systems.modules.movement.fastladder.FastLadderPlus;
import meteordevelopment.meteorclient.systems.modules.movement.fly.FlyPlus;
import meteordevelopment.meteorclient.systems.modules.movement.jesus.JesusPlus;
import meteordevelopment.meteorclient.systems.modules.movement.nofall.NoFallPlus;
import meteordevelopment.meteorclient.systems.modules.movement.noslow.NoSlowPlus;
import meteordevelopment.meteorclient.systems.modules.movement.scaffold.ScaffoldPlus;
import meteordevelopment.meteorclient.systems.modules.movement.speed.Speed;
import meteordevelopment.meteorclient.systems.modules.movement.spider.SpiderPlus;
...
import meteordevelopment.meteorclient.systems.modules.world.autoobsidianmine.AutoObsidianFarm;
import meteordevelopment.meteorclient.systems.modules.world.customblocks.CustomBlocksModule;
import meteordevelopment.meteorclient.systems.modules.world.timer.TimerPlus;
import meteordevelopment.meteorclient.systems.modules.world.zones.ZonesModule;
...
public class Modules extends System<Modules> {
    ...
    private void initCombat() {
        ...
        add(new SelfWeb());
        add(new Surround());
        add(new CriticalsPlus());
        add(new KillAuraPlus());
        add(new VelocityPlus());
    }
    ...
    private void initRender() {
        ...
        add(new Zoom());
        add(new EyeFinder());
        add(new ItemFrameEsp());
        add(new ItemHighlightPlus());
        add(new KillEffect());
    }
    ...
    private void initWorld() {
        ...
        add(new VeinMiner());
        add(new TimerPlus());
        add(new AutoObsidianFarm());
        add(new CustomBlocksModule());
        add(new ZonesModule());
        add(new BedrockStorageBruteforce());
