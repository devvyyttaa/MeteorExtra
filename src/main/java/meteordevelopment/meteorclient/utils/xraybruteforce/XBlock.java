package meteordevelopment.meteorclient.utils.xraybruteforce;
...
import meteordevelopment.meteorclient.systems.modules.world.XrayBruteforce;
...
public class XBlock {
	...
	public XBlock getSideBlock(int side) {
		switch (side) {
	...
	private void assignGroup() {
		XGroup firstGroup = null;

		for (int side : SIDES) {
			if ((neighbours & side) != side) continue;

			XBlock neighbour = getSideBlock(side);
